...
public class hasteskill extends Item {




    public hasteskill(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if(!pLevel.isClientSide && !pPlayer.getCooldowns().isOnCooldown(this))  {
            ...
            pPlayer.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 600,16,false,false));
